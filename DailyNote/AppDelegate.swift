...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func applicationDidBecomeActive(_ application: UIApplication) {
        ...
        WJLocalNotificationUtils.deleteNoteLocalNotification()
        WJLocalNotificationUtils.addNoteLocalNotification()
...
extension AppDelegate {
    func registerPlatformKey() {
        Bmob.register(withAppKey: kBmobAppKey)
    }
}
